...
## **Project Workflow**
1. Terraform provisions the Azure Web App and environment.  
2. Docker builds the FastAPI app into a container image.  
3. CI pipeline builds and validates the image on commit.  
4. CD pipeline deploys the container and applies Terraform changes.  
5. FastAPI retrieves Dataverse **Accounts** data through Graph API.  
